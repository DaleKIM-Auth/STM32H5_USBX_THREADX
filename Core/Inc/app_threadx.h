...
#endif
/* USER CODE BEGIN MTD */
#define TX_TDM_THREAD_STACK_SIZE              TX_APP_STACK_SIZE
#define TX_TDM_THREAD_PRIO                    TX_APP_THREAD_PRIO
#define TX_TDM_THREAD_PREEMPTION_THRESHOLD    TX_TDM_THREAD_PRIO
/* USER CODE END MTD */
